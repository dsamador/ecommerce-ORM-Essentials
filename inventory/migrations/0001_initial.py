    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('is_active', models.BooleanField(default=False)),
                ('stock_status', models.CharField(choices=[('IS', 'In Stock'), ('OOS', 'Out of Stock'), ('BO', 'Backordered')], default='OOS', max_length=3)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('attribute_values', models.ManyToManyField(related_name='attribute_values', to='inventory.attribute')),
